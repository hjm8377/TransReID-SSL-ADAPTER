...
__factory = {
    ...
    'AY21': AY21,
    'nightreid': NightReID,
    'datatang_s_IR': DataTang_s_IR,
    'datatang_s_RGB': DataTang_s_RGB,
    'syndark': SynDark,
    'combined': CombinedReID,
    'cuhk': CUHK,
    'anyang': Anyang,
    'AY': AY_Test
}
...
def make_dataloader(cfg):
    ...
    if cfg.DATASETS.NAMES == 'ourapi':
        ...
        if cfg.DATASETS.NAMES == 'combined':
            dataset = __factory[cfg.DATASETS.NAMES](root=cfg.DATASETS.ROOT_DIR, specs=cfg.DATASETS.SPECS)
        else:
